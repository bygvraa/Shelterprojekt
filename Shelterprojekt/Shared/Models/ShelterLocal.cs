...
namespace Shelterprojekt.Shared.Models
{
    public class ShelterLocal
    {
        ...
        public ShelterLocal(string navn, string cvr_navn, string handicap, string antal_pl, string postnr, string vejnavn, string kontakt_ved)
        {
            this.navn = navn;
